...
docker cp ../machine_learning/models/rain/random_forest_model namenode:/models/amount_of_rain/
docker cp ../machine_learning/models/rain/logistic_regression_model namenode:/models/amount_of_rain/
...
docker exec namenode hdfs dfs -put -f /models/rain/random_forest_model/ /models/amount_of_rain/
docker exec namenode hdfs dfs -put -f /models/rain/logistic_regression_model/ /models/amount_of_rain/
